...
- Field类型
  ...
  - SortedDocValuesField：按`byte[]`列索引以进行排序，存储列用于打分排序
  - SortedSetDocValuesField：按`SortedSet<byte[]>`列索引以进行排序，存储列用于打分排序
  - NumericDocValuesField：按`long`列索引以进行排序，存储列用于打分排序
  - SortedNumericDocValuesField：按`SortedSet<long>`列索引以进行排序，存储列用于打分排序
