...
- Field类型
  ...
  - SortedDocValuesField：按`byte[]`建立正排索引，字符串排序
  - SortedSetDocValuesField：按`SortedSet<byte[]>`建立正排索引，字符串排序
  - NumericDocValuesField：按`long`建立正排索引，数字排序
  - SortedNumericDocValuesField：按`SortedSet<long>`建立正排索引，数字排序
